...
${OBJECTDIR}/ValidationFormate.o: ValidationFormate.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ValidationFormate.o ValidationFormate.cpp
...
${OBJECTDIR}/ValidationFormate_nomain.o: ${OBJECTDIR}/ValidationFormate.o ValidationFormate.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ValidationFormate_nomain.o ValidationFormate.cpp;\
	else  \
